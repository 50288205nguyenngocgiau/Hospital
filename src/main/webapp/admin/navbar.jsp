...
<!--         <li class="nav-item"> -->
<!--           <a class="nav-link active" aria-current="page" href="user_login.jsp">APPOTTNMENT</a> -->
<!--         </li> -->
<!--         <li class="nav-item"> -->
<!--           <a class="nav-link active" aria-current="page" href="user_login.jsp">VIEW APPOTTNMENT</a> -->
<!--         </li> -->
        <li class="nav-item dropdown">
          <a class="nav-link btn-success dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Account Admin 	
          </a>
